...
#define PinRecord HDLocalizedString(@"message.toolBar.record.touch", @"hold down to talk")
#define EndOrSlide HDLocalizedString(@"recording_description", @"Release to end, finger up to cancel sending")
#define CancelRecord HDLocalizedString(@"message.toolBar.record.loosenCancel", @" loosen the fingers, to cancel sending ")
#define TimeIsTooShort HDLocalizedString(@"media.timeShort", @"record time too short")
#define NotStartedRecording HDLocalizedString(@"not_start_recording", @"Didn't start the recording")
...
- (void)setupSubviews
{
    ...
    [_recordButton setImage:[UIImage imageNamed:HDUIResourceItemPath(@"hd_record_menu_mic_gray")] forState:UIControlStateNormal];
    [_recordButton setImage:[UIImage imageNamed:HDUIResourceItemPath(@"hd_record_menu_mic_recording")] forState:UIControlStateHighlighted];
...
{
    [self setButtonImage:HDUIResourceItemPath(@"hd_record_menu_mic_gray") andLabelText:PinRecord];
...
{
    [self setButtonImage:HDUIResourceItemPath(@"hd_record_menu_mic_cancel") andLabelText:CancelRecord];
...
{
    [self setButtonImage:HDUIResourceItemPath(@"hd_record_menu_mic_gray") andLabelText:EndOrSlide];
...
- (void)ListenTime
{
    ...
    [self setButtonImage:HDUIResourceItemPath(@"hd_record_menu_too_short") andLabelText:TimeIsTooShort];
...
//{
//    [self setButtonImage:HDUIResourceItemPath(@"hd_record_menu_too_short") andLabelText:NotStartedRecording];
//    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
//        [self setButtonImage:HDUIResourceItemPath(@"hd_record_menu_mic_gray") andLabelText:PinRecord];
//    });
//}
