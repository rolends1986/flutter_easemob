...
- (void)_setupSubviews
{
    ...
    _backgroundImageView.image = [[UIImage imageNamed:HDUIResourceItemPath(@"messageToolbarBg")] stretchableImageWithLeftCapWidth:0.5 topCapHeight:10];
    ...
    [styleChangeButton setImage:[UIImage imageNamed:HDUIResourceItemPath(@"hd_chatting_setmode_voice_btn_normal")] forState:UIControlStateNormal];
    [styleChangeButton setImage:[UIImage imageNamed:HDUIResourceItemPath(@"hd_chatting_setmode_keyboard_btn_normal")] forState:UIControlStateSelected];
    ...
    [self.faceButton setImage:[UIImage imageNamed:HDUIResourceItemPath(@"hd_chatting_biaoqing_btn_normal")] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:HDUIResourceItemPath(@"hd_chatting_setmode_keyboard_btn_normal")] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:HDUIResourceItemPath(@"hd_type_select_btn_nor")] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:HDUIResourceItemPath(@"hd_type_less_btn_nor")] forState:UIControlStateSelected];
