...
- (void)setupSubviewsForType:(HDChatToolbarType)type
{
    ...
    _photoButton = [self btnWithImage:[UIImage imageNamed:HDUIResourceItemPath(@"hd_chat_image_normal")]
                    highlightedImage:[UIImage imageNamed:HDUIResourceItemPath(@"hd_chat_image_pressed")]
                               title:@"图片"];
    ...
    _takePicButton = [self btnWithImage:[UIImage imageNamed:HDUIResourceItemPath(@"hd_chat_takepic_normal")]
                       highlightedImage:[UIImage imageNamed:HDUIResourceItemPath(@"hd_chat_takepic_pressed")]
                                  title:@"拍照"];
...
//    
//    _videoCallButton = [self btnWithImage:[UIImage imageNamed:HDUIResourceItemPath(@"em_chat_video_normal")]
//                         highlightedImage:[UIImage imageNamed:HDUIResourceItemPath(@"em_chat_video_pressed")]
//                                    title:HDLocalizedString(@"attach_call_video", @"Call Video")];
//
...
//
//    _locationButton = [self btnWithImage:[UIImage imageNamed:HDUIResourceItemPath(@"hd_chat_location_normal")]
//                        highlightedImage:[UIImage imageNamed:HDUIResourceItemPath(@"hd_chat_location_pressed")]
//                                   title:HDLocalizedString(@"attach_location", @"Location")];
...
//
//    _leaveMessageButton = [self btnWithImage:[UIImage imageNamed:HDUIResourceItemPath(@"em_chat_phrase_normal")]
//                            highlightedImage:[UIImage imageNamed:HDUIResourceItemPath(@"em_chat_phrase_pressed")]
//                                       title:HDLocalizedString(@"leave_title", @"Note")];
...
//
//
//    _evaluationButton = [self btnWithImage:[UIImage imageNamed:HDUIResourceItemPath(@"em_chat_evaluation_normal")]
//                          highlightedImage:[UIImage imageNamed:HDUIResourceItemPath(@"em_chat_evaluation_pressed")]
//                                     title:HDLocalizedString(@"evaluation", @"Evaluation")];
//
